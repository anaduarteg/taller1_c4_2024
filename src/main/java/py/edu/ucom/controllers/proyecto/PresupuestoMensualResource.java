...
import py.edu.ucom.services.proyecto.PresupuestoMensualService;

@Path("Presupuesto Mensual")
public class PresupuestoMensualResource {
    private final PresupuestoMensualService service;

    public PresupuestoMensualResource(PresupuestoMensualService service) {
    ...
    public ApiResponse<PresupuestoMensual> obtenerPorId(
            @PathParam("id") Integer id) {
        ApiResponse<PresupuestoMensual> respuesta = new ApiResponse();
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public ApiResponse<List<PresupuestoMensual>> listar() {
        ApiResponse<List<PresupuestoMensual>> respuesta = new ApiResponse();
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public ApiResponse<PresupuestoMensual> agregar(PresupuestoMensual param) {
        ApiResponse<PresupuestoMensual> respuesta = new ApiResponse();
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public ApiResponse<PresupuestoMensual> modificar(PresupuestoMensual param, @PathParam("id") Integer Id) {
        ApiResponse<PresupuestoMensual> respuesta = new ApiResponse();
